...
const App = () => {
  ...
  // =========================================================================
  // ARQUITECTURA DE ALARMAS NATIVAS Y SERVICIO EN PRIMER PLANO (ESTABILIZADO)
  // =========================================================================
  
  // 1. Inicialización Defensiva (Solo una vez al abrir)
  useEffect(() => {
    const initializeSystem = async () => {
      try {
        ...
        // Crea la notificación fija por primera vez. NO PARPADEA.
        try {
            await ForegroundService.startForegroundService({
              id: 1234,
              title: '\u2694 WAR CONTROL', 
              body: 'Sistema táctico en espera. Fija una hora para comenzar.',
              smallIcon: 'ic_lock_idle_alarm' // Icono interno de Android obligatorio
            });
        } catch (serviceError) {
  ...
  // 2. Programar alarma exacta nativa (Con parche de seguridad de 32-bits)
  ...
  // ==========================================
  // ACTUALIZACIÓN FIJA Y LIMPIA DE LA NOTIFICACIÓN AL SINCRONIZAR
  // ==========================================
  const syncWar = async () => {
    ...
    // Se actualiza el banner del sistema UNA VEZ para evitar el parpadeo
    const timeParts = end.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true }).split(' ');
    ...
    try {
        await ForegroundService.startForegroundService({
            id: 1234,
            title: '\u2694 WAR CONTROL',
            body: `Guerra finaliza: ${timeStr} | Monitoreando en segundo plano...`,
            smallIcon: 'ic_lock_idle_alarm'
        });
